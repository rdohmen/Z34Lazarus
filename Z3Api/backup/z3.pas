...
const
  ...
  Z3_MINOR_VERSION   = 8;
  Z3_BUILD_NUMBER    = 5;
  Z3_REVISION_NUMBER = 10333;
  Z3_FULL_VERSION    = 'Z3 4.8.5.10333 6e60926cc383';

type
  Z3_symbol            = Pointer;
  PZ3_symbol           = ^Z3_symbol;

  Z3_literals          = Pointer;
  PZ3_literals         = ^Z3_literals;

  Z3_config            = Pointer;
  PZ3_config           = ^Z3_config;

  Z3_context           = Pointer;
  PZ3_context          = ^Z3_context;

  PZ3_sort             = ^Z3_sort;

  Z3_func_decl         = Pointer;
  PZ3_func_decl        = ^Z3_func_decl;
  ...
  Z3_pattern           = Pointer;
  PZ3_pattern          = ^Z3_pattern;

  Z3_model             = Pointer;
  PZ3_model            = ^Z3_model;

  Z3_constructor       = Pointer;
  PZ3_constructor      = ^Z3_constructor;

  Z3_constructor_list  = Pointer;
  PZ3_constructor_list = ^Z3_constructor_list;

  Z3_params            = Pointer;
  PZ3_params           = ^Z3_params;

  Z3_param_descrs      = Pointer;
  PZ3_param_descrs     = ^Z3_param_descrs;

  Z3_goal              = Pointer;
  PZ3_goal             = ^Z3_goal;

  Z3_tactic            = Pointer;
  PZ3_tactic           = ^Z3_tactic;
  ...
  Z3_solver            = Pointer;
  PZ3_solver           = ^Z3_solver;

  Z3_ast_vector        = Pointer;
  PZ3_ast_vector       = ^Z3_ast_vector;

  Z3_ast_map           = Pointer;
  PZ3_ast_map          = ^Z3_ast_map;

  Z3_apply_result      = Pointer;
  PZ3_apply_result     = ^Z3_apply_result;

  PZ3_func_interp      = ^Z3_func_interp;

  Z3_func_entry        = Pointer;
  PZ3_func_entry       = ^Z3_func_entry;

  Z3_fixedpoint        = Pointer;
  PZ3_fixedpoint       = ^Z3_fixedpoint;

  Z3_optimize          = Pointer;
  PZ3_optimize         = ^Z3_optimize;

  Z3_rcf_num           = Pointer;
  PZ3_rcf_num          = ^Z3_rcf_num;
  (**
     \brief Z3 string type. It is just an alias for \ccode{const char *}.
   *)
  //doh: PUTF8Char == ^Ansichar
  //Z3_string           = PUTF8Char;
  Z3_string           = ^ansichar;
  ...
  Z3_symbol_kind = (
    Z3_INT_SYMBOL    = 0,
    Z3_STRING_SYMBOL = 1);
  PZ3_symbol_kind = ^Z3_symbol_kind;
  ...
  PZ3_parameter_kind = ^Z3_parameter_kind;
  ...
  PZ3_ast_print_mode = ^Z3_ast_print_mode;
  ...
  Z3_error_code = (
    ...
    Z3_DEC_REF_ERROR     = 11,
    Z3_EXCEPTION         = 12);
  PZ3_error_code = ^Z3_error_code;

  (**
     \brief Z3 custom error handler (See #Z3_set_error_handler).
   *)
  Z3_error_handler = procedure(c: Z3_context; e: Z3_error_code); cdecl;
 ...
 *)
function Z3_mk_int_sort(c: Z3_context): Z3_sort; cdecl; external z3_dll name  'Z3_mk_int_sort';
 ...
 *)
function Z3_mk_real_sort(c: Z3_context): Z3_sort; cdecl; external z3_dll name  'Z3_mk_real_sort';
 ...
 *)
function Z3_mk_bv_sort(c: Z3_context; sz: Cardinal): Z3_sort; cdecl; external z3_dll name  'Z3_mk_bv_sort';
 ...
 *)
function Z3_mk_finite_domain_sort(c: Z3_context; name: Z3_symbol; size: UInt64): Z3_sort; cdecl; external z3_dll name  'Z3_mk_finite_domain_sort';
 ...
 *)
function Z3_mk_array_sort(c: Z3_context; domain: Z3_sort; range: Z3_sort): Z3_sort; cdecl; external z3_dll name  'Z3_mk_array_sort';
 ...
 *)
function Z3_mk_array_sort_n(c: Z3_context; n: Cardinal; domain: PZ3_sort; range: Z3_sort): Z3_sort; cdecl; external z3_dll name  'Z3_mk_array_sort_n';
 ...
 *)
function Z3_mk_ge(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_ge';
 ...
 *)
function Z3_mk_int2real(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_int2real';
 ...
 *)
function Z3_mk_real2int(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_real2int';
 ...
 *)
function Z3_mk_is_int(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_is_int';
 ...
 *)
function Z3_mk_bvnot(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvnot';
 ...
 *)
function Z3_mk_bvredand(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvredand';
 ...
 *)
function Z3_mk_bvredor(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvredor';
 ...
 *)
function Z3_mk_bvand(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvand';
 ...
 *)
function Z3_mk_bvor(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvor';
 ...
 *)
function Z3_mk_bvxor(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvxor';
 ...
 *)
function Z3_mk_bvnand(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvnand';
 ...
 *)
function Z3_mk_bvnor(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvnor';
 ...
 *)
function Z3_mk_bvxnor(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvxnor';
 ...
 *)
function Z3_mk_bvneg(c: Z3_context; t1: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvneg';
 ...
 *)
function Z3_mk_bvadd(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvadd';
 ...
 *)
function Z3_mk_bvsub(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvsub';
 ...
 *)
function Z3_mk_bvmul(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvmul';
 ...
 *)
function Z3_mk_bvudiv(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvudiv';
 ...
 *)
function Z3_mk_bvsdiv(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvsdiv';
 ...
 *)
function Z3_mk_bvurem(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvurem';
 ...
 *)
function Z3_mk_bvsrem(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvsrem';
 ...
 *)
function Z3_mk_bvsmod(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvsmod';
 ...
 *)
function Z3_mk_bvult(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvult';
 ...
 *)
function Z3_mk_bvslt(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvslt';
 ...
 *)
function Z3_mk_bvule(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvule';
 ...
 *)
function Z3_mk_bvsle(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvsle';
 ...
 *)
function Z3_mk_bvuge(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl;  external z3_dll name  'Z3_mk_bvuge';
 ...
 *)
function Z3_mk_bvsge(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvsge';
 ...
 *)
function Z3_mk_bvugt(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvugt';
 ...
 *)
function Z3_mk_bvsgt(c: Z3_context; t1: Z3_ast; t2: Z3_ast): Z3_ast; cdecl; external z3_dll name  'Z3_mk_bvsgt';
 ...
 *)
function Z3_mk_unsigned_int(c: Z3_context; v: Cardinal; ty: Z3_sort): Z3_ast; cdecl; external z3_dll name  'Z3_mk_unsigned_int';
...
*)
function Z3_solver_get_trail(c: Z3_context; s: Z3_solver): Z3_ast_vector; cdecl;
   external z3_dll name  'Z3_solver_get_trail';
...
*)
procedure Z3_solver_get_levels(c: Z3_context; s: Z3_solver; literals: Z3_ast_vector; sz: Cardinal; levels: PCardinal); cdecl;
  external z3_dll name  'Z3_solver_get_levels';
...
*)
function Z3_solver_to_dimacs_string(c: Z3_context; s: Z3_solver): Z3_string; cdecl;
  external z3_dll name  'Z3_solver_to_dimacs_string';
