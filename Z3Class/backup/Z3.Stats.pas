...
begin
  //var r : Double := Z3_stats_get_double_value(ctx.ToZ3_Context, m_stats, i);
  r  := Z3_stats_get_double_value(ctx.ToZ3_Context, m_stats, i);
  check_error;
  Result := r;
end;
...
begin
  //var r : Cardinal := Z3_stats_get_uint_value(ctx.ToZ3_Context, m_stats, i);
  r  := Z3_stats_get_uint_value(ctx.ToZ3_Context, m_stats, i);
   check_error();
   Result := r
end;
...
begin
  //var r : Boolean := Z3_stats_is_double(ctx.ToZ3_Context, m_stats, i);
  r  := Z3_stats_is_double(ctx.ToZ3_Context, m_stats, i);
  check_error;
  Result := r
end;
...
begin
  //var r : Boolean := Z3_stats_is_uint(ctx.ToZ3_Context, m_stats, i);
  r := Z3_stats_is_uint(ctx.ToZ3_Context, m_stats, i);
  check_error;
  Result := r
end;
...
begin
  //var s : Z3_string := Z3_stats_get_key(ctx.ToZ3_Context, m_stats, i);
  s  := Z3_stats_get_key(ctx.ToZ3_Context, m_stats, i);
  check_error;
  Result := s;
end;
