...
//doh: inline variable declaration (and assignment) removed
...
begin
     s  := bv_sort(sz);
     r  := Z3_mk_numeral(m_ctx, n, s.ToZ3_Sort);
     //var s : TSort  := bv_sort(sz);
     //var r : Z3_ast := Z3_mk_numeral(m_ctx, n, s.ToZ3_Sort);
...
begin
    s  := bv_sort(sz);
    r  := Z3_mk_unsigned_int64(m_ctx, n, s.ToZ3_Sort);
    //var s : Tsort := bv_sort(sz);
    //var r : Z3_ast:= Z3_mk_unsigned_int64(m_ctx, n, s.ToZ3_Sort);
...
begin
    s  := bv_sort(sz);
    r  := Z3_mk_int64(m_ctx, n, s.ToZ3_Sort);
    //var  s : TSort := bv_sort(sz);
    //var  r : Z3_ast:= Z3_mk_int64(m_ctx, n, s.ToZ3_Sort);
...
begin
     s  := bv_sort(sz);
     r  := Z3_mk_unsigned_int(m_ctx, n, s.ToZ3_Sort);
     //var s : TSort := bv_sort(sz);
     //var r : Z3_ast:= Z3_mk_unsigned_int(m_ctx, n, s.ToZ3_Sort);
...
begin
    s := bv_sort(sz);
    r := Z3_mk_int(m_ctx, n, s.ToZ3_Sort);
    //var s : TSort := bv_sort(sz);
    //var r : Z3_ast:= Z3_mk_int(m_ctx, n, s.ToZ3_Sort);
...
begin
     ...
     _bits  := TZ3Array<Boolean>.Create(n);
     //var  _bits : TZ3Array<Boolean> := TZ3Array<Boolean>.Create(n);

       //for var i : Cardinal := 0 to n - 1 do
     //   _bits[i] = bits[i] ? 1 : 0;
     r   := Z3_mk_bv_numeral(m_ctx, n, _bits.ptr);
     //var r : Z3_ast  := Z3_mk_bv_numeral(m_ctx, n, _bits.ptr);
...
begin
    r := Z3_mk_const(m_ctx, name, s.ToZ3_Sort);
...
begin
    r  := Z3_mk_int(m_ctx, n, int_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_int(m_ctx, n, int_sort.ToZ3_Sort);
...
begin
    r  := Z3_mk_unsigned_int(m_ctx, n, int_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_unsigned_int(m_ctx, n, int_sort.ToZ3_Sort);
...
begin
    r  := Z3_mk_int64(m_ctx, n, int_sort.ToZ3_Sort);
    ///var r : Z3_ast := Z3_mk_int64(m_ctx, n, int_sort.ToZ3_Sort);
...
begin
    r  := Z3_mk_unsigned_int64(m_ctx, n, int_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_unsigned_int64(m_ctx, n, int_sort.ToZ3_Sort);
...
begin
     r  := Z3_mk_numeral(m_ctx, n, int_sort.ToZ3_Sort);
     //var r : Z3_ast := Z3_mk_numeral(m_ctx, n, int_sort.ToZ3_Sort);
...
begin
    s  := fpa_sort(32);
    r := Z3_mk_fpa_numeral_float(m_ctx, n, s.ToZ3_Sort);
    //var s : TSort := fpa_sort(32);
    //var r : Z3_ast:= Z3_mk_fpa_numeral_float(m_ctx, n, s.ToZ3_Sort);
...
begin
    s  := fpa_sort(64);
    r := Z3_mk_fpa_numeral_double(m_ctx, n, s.ToZ3_Sort);
    //var s : TSort := fpa_sort(64);
    //var r : Z3_ast:= Z3_mk_fpa_numeral_double(m_ctx, n, s.ToZ3_Sort);
...
begin
     r  := Z3_mk_numeral(m_ctx, n, real_sort.ToZ3_Sort);
     //Var r : Z3_ast := Z3_mk_numeral(m_ctx, n, real_sort.ToZ3_Sort);
...
begin
    r := Z3_mk_unsigned_int64(m_ctx, n, real_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_unsigned_int64(m_ctx, n, real_sort.ToZ3_Sort);
...
begin
    r  := Z3_mk_int64(m_ctx, n, real_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_int64(m_ctx, n, real_sort.ToZ3_Sort);
...
begin
     r  := Z3_mk_int(m_ctx, n, real_sort.ToZ3_Sort);
     //var r : Z3_ast := Z3_mk_int(m_ctx, n, real_sort.ToZ3_Sort);
...
begin
    r  := Z3_mk_unsigned_int(m_ctx, n, real_sort.ToZ3_Sort);
    //var r : Z3_ast := Z3_mk_unsigned_int(m_ctx, n, real_sort.ToZ3_Sort);
...
begin
    ...
    f := Z3_mk_rec_func_decl(m_ctx, name.ToZ3_symbol, arity, args.ptr, range.ToZ3_Sort);
...
//doh: elemtns added to array one by one
...
begin
    ...
    dom.create;
    TAppender<TSort>.Append(dom, d1);
    TAppender<TSort>.Append(dom, d2);
...
begin
    ...
    args.create;
    TAppender<Z3_sort>.Append(args, domain.ToZ3_sort);


    f  := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 1, @args[0], range.ToZ3_Sort);
    //var f : Z3_func_decl := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 1, @args[0], range.ToZ3_Sort);
...
begin
    ...
    args.create;
    TAppender<Z3_sort>.Append(args, d1.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d2.ToZ3_Sort);

    f  := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 2, @args[0], range.ToZ3_Sort);
    //var f : Z3_func_decl := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 2, @args[0], range.ToZ3_Sort);
...
var args : array of Z3_sort;
    f : Z3_func_decl;// := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 3, @args[0], range.ToZ3_Sort);
...
begin
    ...
    TAppender<Z3_sort>.Append(args, d1.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d2.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d3.ToZ3_Sort);

    //doh:
    //var f : Z3_func_decl := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 3, @args[0], range.ToZ3_Sort);
    f := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 3, @args[0], range.ToZ3_Sort);
...
var args : array of Z3_sort;
    f : Z3_func_decl;// := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 4, @args[0], range.ToZ3_Sort);
...
begin
    ...
    TAppender<Z3_sort>.Append(args, d2.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d3.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d4.ToZ3_Sort);

    f  := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 4, @args[0], range.ToZ3_Sort);
...
var args : array of Z3_sort;
    f : Z3_func_decl;// := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 5, @args[0], range.ToZ3_Sort);
...
begin
    ...
    TAppender<Z3_sort>.Append(args, d3.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d4.ToZ3_Sort);
    TAppender<Z3_sort>.Append(args, d5.ToZ3_Sort);

    f  := Z3_mk_func_decl(m_ctx, str_symbol(name).ToZ3_symbol, 5, @args[0], range.ToZ3_Sort);
...
var
  args : TZ3Array<Z3_sort>;
  i    : Integer;
  f    : Z3_func_decl;// := Z3_mk_func_decl(m_ctx, name.ToZ3_symbol, arity, args.ptr, range.ToZ3_Sort);
...
begin
    ...
    f  := Z3_mk_func_decl(m_ctx, name.ToZ3_symbol, arity, args.ptr, range.ToZ3_Sort);
...
var
  args : TZ3Array<Z3_sort>;
  i    : Integer;
  f    : Z3_func_decl;// := Z3_mk_func_decl(m_ctx, name.ToZ3_symbol, domain.size, args.ptr, range.ToZ3_Sort);
...
begin
    ...
    f  := Z3_mk_func_decl(m_ctx, name.ToZ3_symbol, domain.size, args.ptr, range.ToZ3_Sort);
...
var dom : TZ3Array<Z3_Sort>;
    s   : Z3_Sort;//  := Z3_mk_array_Sort_n(m_ctx, dom.size, dom.ptr, r);

begin
    dom := d.ToArray;

    s     := Z3_mk_array_Sort_n(m_ctx, dom.size, dom.ptr, r);
...
begin
   //var r : Z3_ast_vector := Z3_parse_smtlib2_file(Self, ffile, 0, 0, 0, 0, 0, 0);
   r  := Z3_parse_smtlib2_file(Self, ffile, 0, 0, 0, 0, 0, 0);
   check_error;
...
begin
    ...
    //var r : Z3_ast_vector  := Z3_parse_smtlib2_file(Self, s, sorts.size, sort_names.ptr, sorts1.ptr, decls.size, decl_names.ptr, decls1.ptr);
    r  := Z3_parse_smtlib2_file(Self, s, sorts.size, sort_names.ptr, sorts1.ptr, decls.size, decl_names.ptr, decls1.ptr);
    check_error;
    Result := TExpr_vector.Create(Self, r);
...
begin
     //var r : Z3_ast_vector := Z3_parse_smtlib2_string(Self, s, 0, 0, 0, 0, 0, 0);
     r  := Z3_parse_smtlib2_string(Self, s, 0, 0, 0, 0, 0, 0);
...
begin
    ...
    //var r : Z3_ast_vector := Z3_parse_smtlib2_string(Self, s, sorts.size, sort_names.ptr, sorts1.ptr, decls.size, decl_names.ptr, decls1.ptr);
    r  := Z3_parse_smtlib2_string(Self, s, sorts.size, sort_names.ptr, sorts1.ptr, decls.size, decl_names.ptr, decls1.ptr);
...
begin
    //var r : Cardinal  := Z3_get_ast_hash(ctx.ToZ3_Context, m_ast);
    r  := Z3_get_ast_hash(ctx.ToZ3_Context, m_ast);
...
begin
    //var r : Z3_ast_kind  := Z3_get_ast_kind(ctx.ToZ3_Context, m_ast);
    r  := Z3_get_ast_kind(ctx.ToZ3_Context, m_ast);
...
begin
    ...
    //var r : Z3_ast := Z3_mk_seq_at(ctx.ToZ3_Context, Self.ToZ3_ast, index.ToZ3_ast);
    r  := Z3_mk_seq_at(ctx.ToZ3_Context, Self.ToZ3_ast, index.ToZ3_ast);
...
begin
     //var r : Z3_ast := Z3_get_app_arg(ctx.ToZ3_Context, Self.ToZ3_app, i);
     r  := Z3_get_app_arg(ctx.ToZ3_Context, Self.ToZ3_app, i);
...
begin
     //var r : Z3_ast := Z3_mk_repeat(ctx.ToZ3_Context, i, Self.ToZ3_ast);
     r  := Z3_mk_repeat(ctx.ToZ3_Context, i, Self.ToZ3_ast);
...
begin
  //var r : Z3_ast := Z3_mk_seq_unit(ctx.ToZ3_Context, Self.ToZ3_ast);
  r  := Z3_mk_seq_unit(ctx.ToZ3_Context, Self.ToZ3_ast);
...
begin
    ...
    //var r : Z3_ast := Z3_get_quantifier_body(ctx.ToZ3_Context, Self.ToZ3_ast);
    r  := Z3_get_quantifier_body(ctx.ToZ3_Context, Self.ToZ3_ast);
...
begin
    ...
    //var r : Z3_ast := Z3_mk_seq_contains(ctx.ToZ3_Context, Self.ToZ3_ast, s.ToZ3_ast);
    r  := Z3_mk_seq_contains(ctx.ToZ3_Context, Self.ToZ3_ast, s.ToZ3_ast);
...
begin
    //var f : Z3_func_decl := Z3_get_app_decl(ctx.ToZ3_Context, Self.ToZ3_app);
    f  := Z3_get_app_decl(ctx.ToZ3_Context, Self.ToZ3_app);
...
begin
   assert(is_numeral);
   //var r : Z3_ast := Z3_get_denominator(ctx.ToZ3_Context, m_ast);
   r  := Z3_get_denominator(ctx.ToZ3_Context, m_ast);
...
begin
  ...
  //var r : Z3_ast := Z3_mk_seq_extract(ctx.ToZ3_Context, Self.ToZ3_ast, offset.ToZ3_ast, length.ToZ3_ast);
  r  := Z3_mk_seq_extract(ctx.ToZ3_Context, Self.ToZ3_ast, offset.ToZ3_ast, length.ToZ3_ast);
...
begin
    //var r : Z3_ast := Z3_mk_extract(ctx.ToZ3_Context, hi, lo, Self.ToZ3_ast);
    r  := Z3_mk_extract(ctx.ToZ3_Context, hi, lo, Self.ToZ3_ast);
...
begin
   //var s : Z3_sort := Z3_get_sort(m_ctx.ToZ3_Context, m_ast);
   s  := Z3_get_sort(m_ctx.ToZ3_Context, m_ast);
   check_error;
...
begin
   //var r : Cardinal := Z3_get_ast_id(ctx.ToZ3_Context, m_ast);
   r  := Z3_get_ast_id(ctx.ToZ3_Context, m_ast);
   check_error;
   Result := r;
end;
...
begin
   //var r : Boolean := Z3_get_numeral_int(ctx.ToZ3_Context, m_ast, @i);
   r  := Z3_get_numeral_int(ctx.ToZ3_Context, m_ast, @i);
    check_error;
    Result := r;
end;
...
begin
   //var r : Boolean := Z3_get_numeral_int64(ctx.ToZ3_Context, m_ast, @i);
   r  := Z3_get_numeral_int64(ctx.ToZ3_Context, m_ast, @i);
   check_error;
   Result := r;
end;
...
begin
   //var r : Boolean := Z3_get_numeral_uint(ctx.ToZ3_Context, m_ast, @i);
   r  := Z3_get_numeral_uint(ctx.ToZ3_Context, m_ast, @i);
    check_error;
    Result := r;
end;
...
begin
   //var r : Boolean := Z3_get_numeral_uint64(ctx.ToZ3_Context, m_ast, @i);
   r  := Z3_get_numeral_uint64(ctx.ToZ3_Context, m_ast, @i);
     check_error;
     Result := r;
end;
...
begin
   //var r : Boolean := Z3_is_well_sorted(ctx.ToZ3_Context, m_ast);
   r  := Z3_is_well_sorted(ctx.ToZ3_Context, m_ast);
   check_error;
   Result := r;
end;
...
begin
   //var  r : Z3_ast := Z3_mk_int_to_str(ctx.ToZ3_Context, Self.ToZ3_ast);
   r  := Z3_mk_int_to_str(ctx.ToZ3_Context, Self.ToZ3_ast);
  check_error;
  Result := TExpr.Create(ctx, r);
end;
...
begin
   //var r : Z3_ast := Z3_mk_seq_length(ctx.ToZ3_Context,Self.ToZ3_ast);
   r  := Z3_mk_seq_length(ctx.ToZ3_Context,Self.ToZ3_ast);
  check_error;
  Result := TExpr.Create(ctx, r);
end;
...
begin
   //var r : Z3_ast := Z3_mk_re_loop(ctx.ToZ3_Context, m_ast, lo, hi);
   r  := Z3_mk_re_loop(ctx.ToZ3_Context, m_ast, lo, hi);
  check_error;
  Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r : Z3_ast := Z3_mk_re_loop(ctx.ToZ3_Context, m_ast, lo, 0);
   r  := Z3_mk_re_loop(ctx.ToZ3_Context, m_ast, lo, 0);
  check_error;
  Result := TExpr.Create(ctx, r);
...
begin
  assert(is_numeral);
   ...
   //var r : Z3_ast := Z3_get_numerator(ctx.ToZ3_Context, m_ast);
  r  := Z3_get_numerator(ctx.ToZ3_Context, m_ast);
  check_error;
  Result := TExpr.Create(ctx,r);
end;
...
begin
   ...
   //var r : Cardinal := Z3_get_app_num_args(ctx.ToZ3_Context, Self.ToZ3_app);
   r  := Z3_get_app_num_args(ctx.ToZ3_Context, Self.ToZ3_app);
    check_error;
    Result := r;
end;
...
begin
  ...
  //var r : Z3_ast := Z3_mk_seq_replace(ctx.ToZ3_Context, Self.ToZ3_ast, src.ToZ3_ast, dst.ToZ3_ast);
  r  := Z3_mk_seq_replace(ctx.ToZ3_Context, Self.ToZ3_ast, src.ToZ3_ast, dst.ToZ3_ast);
  check_error;
  Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r :Z3_ast := Z3_mk_rotate_left(ctx.ToZ3_Context, i, Self.ToZ3_ast);
   r  := Z3_mk_rotate_left(ctx.ToZ3_Context, i, Self.ToZ3_ast);
    ctx.check_error;
    Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r :Z3_ast := Z3_mk_rotate_right(ctx.ToZ3_Context, i, Self.ToZ3_ast);
   r  := Z3_mk_rotate_right(ctx.ToZ3_Context, i, Self.ToZ3_ast);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r :Z3_ast := Z3_simplify(ctx.ToZ3_Context, m_ast);
   r  := Z3_simplify(ctx.ToZ3_Context, m_ast);
   check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r :Z3_ast := Z3_simplify_ex(ctx.ToZ3_Context, m_ast, p.ToZ3_params);
   r := Z3_simplify_ex(ctx.ToZ3_Context, m_ast, p.ToZ3_params);
    check_error;
    Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //var r :Z3_ast := Z3_mk_str_to_int(ctx.ToZ3_Context, Self.ToZ3_ast);
   r  := Z3_mk_str_to_int(ctx.ToZ3_Context, Self.ToZ3_ast);
  check_error;
  Result := TExpr.Create(ctx, r);
...
begin
  ...
  //var _src : TZ3Array<Z3_ast> := TZ3Array<Z3_ast>.Create(src.size);
  //var _dst : TZ3Array<Z3_ast> := TZ3Array<Z3_ast>.Create(dst.size);
  _src  := TZ3Array<Z3_ast>.Create(src.size);
  _dst  := TZ3Array<Z3_ast>.Create(dst.size);
...
//var r : Z3_ast := Z3_substitute(ctx.ToZ3_Context, m_ast, src.size, _src.ptr, _dst.ptr);
  r  := Z3_substitute(ctx.ToZ3_Context, m_ast, src.size, _src.ptr, _dst.ptr);
  check_error;
  Result := TExpr.Create(ctx, r);
...
begin
  ...
  //var r : Z3_ast := Z3_substitute_vars(ctx.ToZ3_Context, m_ast, dst.size, _dst.ptr);
  r := Z3_substitute_vars(ctx.ToZ3_Context, m_ast, dst.size, _dst.ptr);
  check_error;
  Result := TExpr.Create(ctx, r);
...
begin
   //var s : Z3_symbol := Z3_get_sort_name(ctx.ToZ3_Context, m_ast);
   s  := Z3_get_sort_name(ctx.ToZ3_Context, m_ast);
   check_error;
...
begin
    assert(is_array);
    //var s : Z3_sort := Z3_get_array_sort_domain(ctx.ToZ3_Context, m_ast);
    s := Z3_get_array_sort_domain(ctx.ToZ3_Context, m_ast);
    check_error;
    Result := TSort.Create(ctx, s);
end;
...
begin
     assert(is_array);
     //var s : Z3_sort := Z3_get_array_sort_range(ctx.ToZ3_Context, m_ast);
     s  := Z3_get_array_sort_range(ctx.ToZ3_Context, m_ast);
     check_error;
     Result := TSort.Create(ctx, s);
end;
...
begin
    assert(is_bv);
    //var r : Cardinal := Z3_get_bv_sort_size(ctx.ToZ3_Context, m_ast);
    r  := Z3_get_bv_sort_size(ctx.ToZ3_Context, m_ast);
    check_error;
    Result := r;
end;
...
begin
    assert(is_fpa);
    //var r : Cardinal := Z3_fpa_get_ebits(ctx.ToZ3_Context, m_ast);
    r  := Z3_fpa_get_ebits(ctx.ToZ3_Context, m_ast);
    check_error;
    Result := r;
end;
...
begin
    assert(is_fpa);
    //var r : Cardinal := Z3_fpa_get_sbits(ctx.ToZ3_Context, m_ast);
    r  := Z3_fpa_get_sbits(ctx.ToZ3_Context, m_ast);
    check_error;
    Result := r;
end;
...
begin
   //var r : Cardinal := Z3_get_sort_id(ctx.ToZ3_Context, m_ast);
   r  := Z3_get_sort_id(ctx.ToZ3_Context, m_ast);
   check_error;
   Result := r;
end;
...
begin
    assert(i < arity);
    //var r : Z3_sort := Z3_get_domain(ctx.ToZ3_Context, self.ToZ3_func_decl, i);
    r  := Z3_get_domain(ctx.ToZ3_Context, self.ToZ3_func_decl, i);
    check_error;
...
begin
   //var r : Cardinal := Z3_get_func_decl_id(ctx.ToZ3_Context, Self.ToZ3_func_decl);
   r  := Z3_get_func_decl_id(ctx.ToZ3_Context, Self.ToZ3_func_decl);
    check_error;
    Result := r;
end;
...
begin
   //var s : Z3_symbol := Z3_get_decl_name(ctx.ToZ3_Context, Self.ToZ3_func_decl);
   s  := Z3_get_decl_name(ctx.ToZ3_Context, Self.ToZ3_func_decl);
    check_error;
    Result := TSymbol.Create(ctx, s);
end;
...
begin
   //var r : Z3_sort := Z3_get_range(ctx.ToZ3_Context, Self.ToZ3_func_decl);
   r  := Z3_get_range(ctx.ToZ3_Context, Self.ToZ3_func_decl);
    check_error;
    Result := TSort.Create(ctx, r);
end;
...
begin
   //var _args : TZ3Array<Z3_ast> :=  TZ3Array<Z3_ast>.Create(args.size);
   _args :=  TZ3Array<Z3_ast>.Create(args.size);
   ...
   //var r : Z3_ast  := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, args.size, _args.ptr);
   r   := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, args.size, _args.ptr);
   check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   //var _args : TZ3Array<Z3_ast> :=  TZ3Array<Z3_ast>.Create(n);
   _args :=  TZ3Array<Z3_ast>.Create(n);
   for i := 0 to  n-1  do
  begin
   ...
   //var r : Z3_ast := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, n, _args.ptr);
   r := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, n, _args.ptr);
   check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   //var r : Z3_ast := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 0, 0);
   r := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 0, 0);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //args :=  [a.ToZ3_ast] ;
   args.create;
   TAppender<Z3_ast>.Append(args, a.ToZ3_ast);
   //var r : Z3_ast := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 1, @args[0]);
   r := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 1, @args[0]);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   args.create;
   TAppender<Z3_ast>.Append(args, ctx.num_val(a, domain(0)).ToZ3_ast);
...
begin
    ...
    //doh:
    //args  := [ a1.ToZ3_ast, a2.ToZ3_ast ];

    args.create;
    TAppender<Z3_ast>.Append(args, a1.ToZ3_ast);
    TAppender<Z3_ast>.Append(args, a2.ToZ3_ast);

    r  := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 2, @args[0]);
    ctx.check_error;
    Result := TExpr.Create(ctx, r);
...
begin
    ...
    //doh:
    //args  := [ a1.ToZ3_ast, ctx.num_val(a2, domain(1)).ToZ3_ast ];

    args.create;
    TAppender<Z3_ast>.Append(args, a1.ToZ3_ast);
    TAppender<Z3_ast>.Append(args, ctx.num_val(a2, domain(1)).ToZ3_ast);
...
begin
    ...
    //doh:
    //args  := [ ctx.num_val(a1, domain(0)).ToZ3_ast, a2.ToZ3_ast ];

    args.create;
    TAppender<Z3_ast>.Append(args, ctx.num_val(a1, domain(0)).ToZ3_ast);
    TAppender<Z3_ast>.Append(args, a2.ToZ3_ast);
...
begin
   ...
   //doh:
   //args  := [ a1.ToZ3_ast, a2.ToZ3_ast, a3.ToZ3_ast ];

   args.create;
   TAppender<Z3_ast>.Append(args, a1.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a2.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a3.ToZ3_ast);

   r  := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 3, @args[0]);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //doh:
   //args  := [ a1.ToZ3_ast, a2.ToZ3_ast, a3.ToZ3_ast, a4.ToZ3_ast ];

   args.create;
   TAppender<Z3_ast>.Append(args, a1.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a2.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a3.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a4.ToZ3_ast);



   r  := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 4, @args[0]);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
   ...
   //doh:
   //args  := [ a1.ToZ3_ast, a2.ToZ3_ast, a3.ToZ3_ast, a4.ToZ3_ast, a5.ToZ3_ast ];
   ...
   TAppender<Z3_ast>.Append(args, a3.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a4.ToZ3_ast);
   TAppender<Z3_ast>.Append(args, a5.ToZ3_ast);

   r  := Z3_mk_app(ctx.ToZ3_Context, Self.ToZ3_func_decl, 5, @args[0]);
   ctx.check_error;
   Result := TExpr.Create(ctx, r);
end;
...
begin
  assert(Index < size);
  //var r : Z3_ast := Z3_ast_vector_get(ctx.ToZ3_Context, m_vector, Index);
  r  := Z3_ast_vector_get(ctx.ToZ3_Context, m_vector, Index);
  check_error;
