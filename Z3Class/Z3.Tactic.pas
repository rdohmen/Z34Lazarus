...
begin
    check_context(t1, t2);
    //var r : Z3_tactic := Z3_tactic_and_then(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
    r  := Z3_tactic_and_then(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
    t1.check_error;
...
begin
    check_context(t1, t2);
    //var r : Z3_tactic := Z3_tactic_or_else(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
    r  := Z3_tactic_or_else(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
    t1.check_error;
    Result := TTactic.Create(t1.ctx, r);
end;
...
begin
    //var r : Z3_tactic := Z3_tactic_repeat(t.ctx.ToZ3_Context, t.ToZ3_tactic, max);
    r  := Z3_tactic_repeat(t.ctx.ToZ3_Context, t.ToZ3_tactic, max);
   t.check_error;
...
begin
  //var r : Z3_tactic := Z3_tactic_using_params(t.ctx.ToZ3_Context, t.ToZ3_tactic, p.ToZ3_params);
  r  := Z3_tactic_using_params(t.ctx.ToZ3_Context, t.ToZ3_tactic, p.ToZ3_params);
  t.check_error;
  Result := TTactic.Create(t.ctx, r);
end;
...
begin
    //var r : Z3_tactic := Z3_tactic_try_for(t.ctx.ToZ3_Context, t.ToZ3_tactic, ms);
    r := Z3_tactic_try_for(t.ctx.ToZ3_Context, t.ToZ3_tactic, ms);
    t.check_error;
    Result := TTactic.Create(t.ctx, r)
end;
...
begin
    ...
    //var buffer : TZ3Array<Z3_tactic> :=  TZ3Array<Z3_tactic>.Create(n);
    //var i : Integer;
    buffer  :=  TZ3Array<Z3_tactic>.Create(n);
...
begin
   check_context(t1, t2);
   //var r : Z3_tactic := Z3_tactic_par_and_then(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
   r  := Z3_tactic_par_and_then(t1.ctx.ToZ3_Context, t1.ToZ3_tactic, t2.ToZ3_tactic);
   t1.check_error;
   Result := TTactic.Create(t1.ctx, r);
end;
...
begin
    ...
    //var new_m : Z3_model := Z3_goal_convert_model(ctx.ToZ3_Context, m_goal, m.ToZ3_model);
    new_m := Z3_goal_convert_model(ctx.ToZ3_Context, m_goal, m.ToZ3_model);
    check_error;
...
begin
    ...
    //var r : Z3_ast := Z3_goal_formula(ctx.ToZ3_Context, m_goal, index);
    r  := Z3_goal_formula(ctx.ToZ3_Context, m_goal, index);
    check_error;
...
begin
    //var new_m : Z3_model := Z3_goal_convert_model(ctx.ToZ3_Context, m_goal, nil);
    new_m  := Z3_goal_convert_model(ctx.ToZ3_Context, m_goal, nil);
    check_error;
    Result := TModel.Create(ctx, new_m);
end;
...
begin
   assert(Integer(index) >= 0);
   //var r : Z3_goal := Z3_apply_result_get_subgoal(ctx.ToZ3_Context, m_apply_result, index);
   r  := Z3_apply_result_get_subgoal(ctx.ToZ3_Context, m_apply_result, index);
   check_error;
...
begin
  inherited Create(c);
  //var  r : Z3_tactic := Z3_mk_tactic(c.ToZ3_Context, name);
  r := Z3_mk_tactic(c.ToZ3_Context, name);
  check_error;
  init(r);
end;
...
begin
    ...
    //var r : Z3_apply_result := Z3_tactic_apply(ctx.ToZ3_Context, m_tactic, g.ToZ3_Goal);
    r  := Z3_tactic_apply(ctx.ToZ3_Context, m_tactic, g.ToZ3_Goal);
    check_error;
...
begin
    //var r : AnsiString := AnsiString( Z3_tactic_get_help(ctx.ToZ3_Context, m_tactic) );
    r := AnsiString( Z3_tactic_get_help(ctx.ToZ3_Context, m_tactic) );
    check_error;
    Result := r;
end;
...
begin
    //var r : Z3_solver := Z3_mk_solver_from_tactic(ctx.ToZ3_Context, m_tactic);
    r  := Z3_mk_solver_from_tactic(ctx.ToZ3_Context, m_tactic);
    check_error;
