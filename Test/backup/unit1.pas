...
(*
procedure TForm2.reLogChange(Sender: TObject);
begin
//doh
//todo
...
*)
//doh
procedure TForm2.check(ctx: Z3_context; s: Z3_solver; expected_result: Z3_lbool);
var
stmp : AnsiString ;
var m   : Z3_model;//  := 0;
...
*)
function TForm2.display_symbol(c : Z3_context;  s: Z3_symbol):AnsiString;
begin
Result := '';
...
*)
//doh
function TForm2.display_sort(c: Z3_context;  ty:Z3_sort): AnsiString;
...
*)
//doh
function TForm2.display_ast(c: Z3_context; v: Z3_ast): AnsiString ;
var i         : Cardinal;
...
*)
//doh
function TForm2.display_function_interpretations(c: Z3_context; m: Z3_model): AnsiString;
var
...
*)
//doh
function TForm2.display_model(c: Z3_context; m: Z3_model): AnsiString;
var name : Z3_symbol;
...
*)
//doh
procedure TForm2.check2(ctx : Z3_context; s: Z3_solver; expected_result: Z3_lbool);
var m   : Z3_model;//  := 0;
var res : Z3_lbool;//  := Z3_solver_check(ctx, s);
begin
//var m   : Z3_model  := 0;
...
*)
//doh
procedure TForm2.prove(ctx: Z3_context; s: Z3_solver; f: Z3_ast; is_valid: Boolean);
var m     : Z3_model;//  := 0;
var not_f : Z3_ast;
...
*)
procedure TForm2.assert_inj_axiom(ctx: Z3_context; s: Z3_solver; f : Z3_func_decl; i: Cardinal);
var
sz, j : Cardinal;
...
*)
procedure TForm2.assert_comm_axiom(ctx: Z3_context; s: Z3_solver; f: Z3_func_decl);
var
t             : Z3_sort;
...
*)
procedure TForm2.simple_example;
var
ctx : Z3_context;
begin
...
*)
procedure TForm2.find_model_example1;
var
ctx           : Z3_context;
x, y, x_xor_y : Z3_ast;
s             : Z3_solver;
...
*)
procedure TForm2.find_model_example2;
var
ctx            : Z3_context;
x, y, one, two,
y_plus_one     : Z3_ast;
...
functions.
*)
procedure TForm2.prove_example1;
var
ctx    : Z3_context;
s      : Z3_solver;
U_name,
...
*)
procedure TForm2.prove_example2;
var
ctx      : Z3_context;
s        : Z3_solver;
int_sort : Z3_sort;
...
*)
procedure TForm2.push_pop_example1;
var
ctx     : Z3_context ;
s       : Z3_solver ;
int_sort: Z3_sort;
...
\sa assert_inj_axiom.
*)
procedure TForm2.quantifier_example1;
var
cfg                  : Z3_config;
ctx                  : Z3_context;
s                    : Z3_solver;
...
*)
procedure TForm2.array_example1;
var
...
*)
procedure TForm2.array_example2;
var
ctx        : Z3_context ;
s          : Z3_solver;
bool_sort,
...
*)
//doh
procedure TForm2.array_example3;
var
...
*)
//doh
procedure TForm2.tuple_example1;
var
...
*)
//doh
procedure TForm2.bitvector_example1;
var
bv_sort : Z3_sort;
...
*)
//doh
procedure TForm2.bitvector_example2;
...
*)
procedure TForm2.eval_example1;
var
x, y, two : Z3_ast;
c1, c2    : Z3_ast;
args      : array[0..1] of Z3_ast;
...
*)
procedure TForm2.two_contexts_example1;
var
...
*)
procedure TForm2.error_code_example1;
var
cfg : Z3_config;
ctx : Z3_context;
s   : Z3_solver;
...
*)
//doh
procedure TForm2.error_code_example2;
var
cfg : Z3_config;
ctx : Z3_context;
e   : Z3_error_code;
...
*)
procedure TForm2.parser_example2;
var
x, y : Z3_ast;
...
\brief Demonstrates how to initialize the parser symbol table.
*)
procedure TForm2.parser_example3;
var
cfg     : Z3_config;
ctx     : Z3_context;
s       : Z3_solver;
...
*)
procedure TForm2.parser_example5;
var
cfg     : Z3_config;
ctx     : Z3_context;
s       : Z3_solver;
...
*)
procedure TForm2.numeral_example;
var
ctx     : Z3_context;
s       : Z3_solver;
n1, n2  : Z3_ast;
...
procedure TForm2.forest_example;
var
tree, forest               : Z3_sort;
...
*)
//doh
procedure TForm2.binary_tree_example;
var
cell             : Z3_sort;
...
//(*
////doh
//procedure TForm2.btnTestX86Click(Sender: TObject);
//begin
//Z3_open_log('z3.log');
//relog.Clear;
//
...
*)
//doh
procedure TForm2.unsat_core_and_proof_example;
var
ctx : Z3_context;
s   : Z3_solver;
...
*)
//doh
function TForm2.ext_check(ctx:Z3_ext_context): Z3_lbool;
var
res             : Z3_lbool;
...
*)
procedure TForm2.incremental_example1;
var
...
*)
procedure TForm2.reference_counter_example;
var
cfg     : Z3_config;
ctx     : Z3_context;
s       : Z3_solver;
...
*)
procedure TForm2.smt2parser_example;
var
ctx : Z3_context;
fs  : Z3_ast_vector;
Begin
...
*)
procedure TForm2.substitute_example;
var
ctx   : Z3_context;
int_ty: Z3_sort;
a, b  : Z3_ast;
...
*)
procedure TForm2.substitute_vars_example;
var
ctx           : Z3_context;
int_ty        : Z3_sort;
x0, x1        : Z3_ast;
...
procedure TForm2.mk_model_example;
var
ctx              : Z3_context;
m                : Z3_model;
intSort          : Z3_sort ;
...
*)
procedure TForm2.prove_(conjecture: TExpr);
var c : TContext ;
...
procedure TForm2.tactic_example7;
(*
...
procedure TForm2.tactic_example6;
(*
...
procedure TForm2.tactic_example5;
(*
...
procedure TForm2.tactic_example4;
(*
...
procedure TForm2.tactic_example3;
var c : TContext;// := TContext.Create;
...
procedure TForm2.tactic_example2;
(*
...
procedure TForm2.tactic_example1;
(*
...
*)
procedure TForm2.unsat_core_example3;
var c : TContext;// := TContext.Create;
...
*)
procedure  TForm2.unsat_core_example2;
var
...
*)
procedure TForm2.unsat_core_example1;
var
i : Integer;
var c : TContext;// := TContext.Create;
...
*)
procedure TForm2.quantifier_example;
var c : TContext;// := TContext.Create;
...
procedure TForm2.ite_example2_;
var c : TContext;// := TContext.Create;
...
\brief Demonstrate different ways of creating rational numbers: decimal and fractional representations.
*)
procedure TForm2.numeral_example_;
var c : TContext;// := TContext.Create;
...
*)
procedure TForm2.error_example_;
var c : TContext;// := TContext.Create;
...
*)
procedure TForm2.two_contexts_example1_;
...
*)
procedure TForm2.eval_example1_;
var c : TContext;// := TContext.Create;
var x : TExpr;// := c.int_const('x');
var y : TExpr;// := c.int_const('y');
var s : TSolver;// := TSolver.Create(c);
...
\brief Find x and y such that: x ^ y - 103 == x * y
*)
procedure  TForm2.bitvector_example2_;
var c : TContext;// := TContext.Create;
var x : TExpr;// := c.bv_const('x',32);
var y : TExpr;// := c.bv_const('y',32);
var s : TSolver;// := TSolver.Create(c);
...
\brief Simple bit-vector example. This example disproves that x - 10 <= 0 IFF x <= 10 for (32-bit) machine integers
*)
procedure  TForm2.bitvector_example1_;
var c : TContext;// := TContext.Create;
var x : TExpr;// := c.bv_const('x',32);
var y : TExpr;// := c.bv_const('y',32);
begin
...
*)
procedure  TForm2.nonlinear_example1_;
...
This example demonstrates how to combine uninterpreted functions and arithmetic.
*)
procedure TForm2.prove_example2_ ;
var c : TContext;// := TContext.Create;
var x : TExpr;// := c.int_const('x');
var y : TExpr;// := c.int_const('y');
var z : TExpr;// := c.int_const('z');
...
functions.
*)
procedure TForm2.prove_example1_;
var c : TContext;// := TContext.Create;
var x : TExpr;// := c.int_const('x');
var y : TExpr;// := c.int_const('y');
var I : TSort;// := c.int_sort;
...
*)
procedure  TForm2.find_model_example1_;
var
i: Integer;
var c : TContext;// := TContext.Create;
...
// probeersel om te zien of een eenvoudige smtlib2 text te parsen/op te lossen is.
...
label
     err  ;
begin
relog.Lines.Append(sLineBreak+ 'smtlib2 test');
LOG_MSG('smtlib2 test');
...
begin
 ...
 Z3_parse_smtlib2_string(ctx,
                        (* the following string has a parsing error: missing parenthesis *)
                        '(declare-const x Int) declare-const y Int) (assert (and (> x y) (> x 0))) (check-sat)',
                        0, 0, 0,
                        0, 0, 0);
 e := Z3_get_error_code(ctx);
 if e <> Z3_OK then
...
// de code is te parsen, nu kijken of het (un)sat is.
if Z3_solver_check(ctx, s) = Z3_L_TRUE then
begin
 //var x_plus_y : Z3_ast;
 //var v        : Z3_ast ;
 ...
 relog.Lines.Append(Format('MODEL:' + sLineBreak+ '%s', [Z3_model_to_string(ctx, m)]));
 //x_plus_y := Z3_mk_add(ctx, 2, @args[0]);
 relog.Lines.Append(sLineBreak + 'evaluating');
